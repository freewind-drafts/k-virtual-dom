...
class TagTest {
    ...
    fun nested_simple_tags() {
        val tags = tag("div",
                ...
                tag("form",
                        ...
                        tag("input"),
                        tag("button")))
        val nodes = TagNode("div", children = listOf(
                TextNode("login"),
    ...
    fun nested_complex_tags() {
        val tags = tag("div#main1.big", attrs("main2", setOf("panel"), mapOf("style" to "color: red")),
                text("login"),
                tag("form.my-form",
                        tag("input.username", attrs("type" to "text")),
                        tag("input.password", attrs("type" to "password")),
                        tag("button.submit.center")))
        val nodes = TagNode("div", Attrs("main1", setOf("big", "panel"), mapOf("style" to "color: red")), children = listOf(
                TextNode("login"),
